...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('home', '0006_eventindexpage_show_events'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('page', modelcluster.fields.ParentalKey(related_name='related_links', to='home.EventIndexPage')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('link_document', models.ForeignKey(related_name='+', blank=True, to='wagtaildocs.Document', null=True)),
                ('link_page', models.ForeignKey(related_name='+', blank=True, to='wagtailcore.Page', null=True)),
                ('page', modelcluster.fields.ParentalKey(related_name='related_links', to='home.EventPage')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
